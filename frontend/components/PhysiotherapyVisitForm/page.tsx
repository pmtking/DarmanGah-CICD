...
const PhysiotherapyVisitForm: React.FC = () => {
    ...
    return (
        <div className=" mx-auto  bg-white min-h-screen rtl text-right" dir="rtl">
            ...
            <div className={`mb-8 p-4 rounded-2xl border flex justify-between items-center ${
                patient.hasFile ? 'bg-blue-50/50 border-blue-100' : 'bg-red-50 border-red-100'
            }`}>
                <div>
                ...
                <div className="text-left">
                    <span className={`px-3 py-1 rounded-full text-xs font-bold ${
                        patient.hasFile ? 'bg-blue-600 text-white' : 'bg-red-600 text-white'
                    }`}>
            ...
            <div className="sticky bottom-4 mt-auto">
                <div className="bg-gray-900 text-white p-4 rounded-2xl shadow-2xl flex flex-col sm:flex-row items-center justify-between gap-4 border border-white/10">
